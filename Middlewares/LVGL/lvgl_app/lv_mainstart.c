...
lv_obj_t * lv_create_page(lv_obj_t *parent)
{
    ...
    lv_obj_set_size(lv_page_obj, lcddev.width, 35);
          ...
          if (lv_flie.SD_fno.fattrib& AM_DIR) /* 读取的是文件夹名字 */
            {
                ...
                lv_obj_set_style_img_recolor(lv_flie.list_btn[lv_flie.list_flie_nuber],lv_color_hex(0xFFD700),LV_STATE_DEFAULT);  /* 设置文件夹重新着色 */
            }
            else /* 读取的是文件名称 */
            {
                ...
                lv_obj_set_style_img_recolor(lv_flie.list_btn[lv_flie.list_flie_nuber],lv_color_hex(0x87CEFA),LV_STATE_DEFAULT);   /* 设置文件重新着色 */
            }
...
void lv_create_list(lv_obj_t *parent)
{
    ...
    lv_obj_set_size(lv_flie.list, lcddev.width, lcddev.height - 40);  /* 设置列表的大小 */
...
void lv_page_tile(lv_obj_t *parent)
{
    ...
    lv_obj_set_size(lv_flie.lv_page_obj,lcddev.width,25);
    ...
    lv_label_set_text(lv_page_label,"file system");
...
void lv_page_back(lv_obj_t *parent)
{
    ...
    lv_obj_set_size(lv_flie.lv_back_obj,lcddev.width,35);                              /* 设置改区域的大小 */
